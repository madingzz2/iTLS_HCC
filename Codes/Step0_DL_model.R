...
train <- read.csv('radiomic/xyh_DL_features.csv')
val1 <- read.csv('radiomic/hainan_DL_features.csv')
val2 <- read.csv('radiomic/mhh_DL_features.csv')
val3 <- read.csv('radiomic/tcia_DL_features.csv')
